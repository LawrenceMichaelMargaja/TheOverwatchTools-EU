...
func getDiDefs(provider dingo.Provider) []di.Def {
	return []di.Def{
		...
		},
		{
			...
			Scope: "",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("logic_capture_pages")
				if err != nil {
				...
				b, ok := d.Build.(func(*config.App, *logrus.Entry, *mysqlconn.Provider, *mysqlstore.Repository) (*capturepageslogic.Service, error))
				if !ok {
					var eo *capturepageslogic.Service
					return eo, errors.New("could not cast build function to func(*config.App, *logrus.Entry, *mysqlconn.Provider, *mysqlstore.Repository) (*capturepageslogic.Service, error)")
				}
		...
		},
		{
			...
			Scope: "",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("logic_capture_pages_sets")
				if err != nil {
					var eo *capturepageslogic.Service
					return eo, err
				}
		...
		},
		{
			...
			Scope: "",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("logic_click_tracker_sets")
				if err != nil {
				...
				b, ok := d.Build.(func(*config.App, *logrus.Entry, *mysqlconn.Provider, *mysqlstore.Repository) (*clicktrackerlogic.Service, error))
				if !ok {
					var eo *clicktrackerlogic.Service
					return eo, errors.New("could not cast build function to func(*config.App, *logrus.Entry, *mysqlconn.Provider, *mysqlstore.Repository) (*clicktrackerlogic.Service, error)")
				}
				return b(p0, p1, p2, p3)
			},
			Unshared: false,
		},
		{
			...
			Scope: "",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("logic_click_trackers")
				if err != nil {
					var eo *clicktrackerlogic.Service
					return eo, err
				}
		...
		},
		{
			...
			Scope: "",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("logic_organization")
				if err != nil {
				...
				b, ok := d.Build.(func(*config.App, *logrus.Entry, *mysqlconn.Provider, *mysqlstore.Repository) (*organizationlogic.Service, error))
				if !ok {
					var eo *organizationlogic.Service
					return eo, errors.New("could not cast build function to func(*config.App, *logrus.Entry, *mysqlconn.Provider, *mysqlstore.Repository) (*organizationlogic.Service, error)")
				}
				return b(p0, p1, p2, p3)
			},
			Unshared: false,
